...
export default function LencoisMaranhensesPage() {
    ...
    <main className="min-h-screen bg-tamarina-creme text-tamarina-marrom overflow-x-hidden">
      ...
      <section className="relative h-[70vh] md:h-[80vh] w-full flex items-end pb-16 md:pb-24 justify-center">
        <div className="absolute inset-0 z-0">
          <Image
            src="https://www.gov.br/turismo/pt-br/assuntos/noticias/parque-nacional-dos-lencois-maranhenses-e-reconhecido-como-patrimonio-natural-da-humanidade/CrditoguilhermespenglerShutterstock.png/@@images/5faf9a18-2c4d-49b2-bb40-990f2bb18803.png"
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto text-tamarina-creme">
          ...
          >
            <span className="flex items-center gap-2">
              <Calendar size={16} className="text-tamarina-areia md:w-[18px] md:h-[18px]" /> 5 a 7 de Junho
            </span>
            <span className="flex items-center gap-2">
              <Clock size={16} className="text-tamarina-areia md:w-[18px] md:h-[18px]" /> 3 Dias / 2 Noites
            </span>
            <span className="flex items-center gap-2">
              <Map size={16} className="text-tamarina-areia md:w-[18px] md:h-[18px]" /> Natureza & Trekking
            </span>
          </motion.div>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
          ...
          <div className="md:w-2/3 space-y-4 md:space-y-6 font-babe text-base md:text-lg leading-relaxed opacity-90">
            <p className="text-xl md:text-2xl font-medium leading-normal mb-6 md:mb-8">
              Uma travessia pensada para mulheres que querem se desafiar, desconectar do caos da rotina e se conectar consigo mesmas em meio às dunas e lagoas cristalinas.
            </p>
            <p>
              Durante três dias, caminharemos por paisagens surreais, descansando em oásis e assistindo ao nascer e pôr do sol nos Lençóis Maranhenses. É um roteiro que combina aventura, presença e companheirismo.
            </p>
            <p>
              Incluímos uma noite de hospedagem pré-trekking em Barreirinhas para que todas cheguem descansadas e prontas para a jornada.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10 md:space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-tamarina-marrom/20">
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-3.5rem)] md:w-[calc(50%-2.5rem)] bg-tamarina-creme p-5 md:p-6 rounded-sm shadow-md">
                <div className="flex items-center justify-between space-x-2 mb-1">
                  <h3 className="font-opti text-xl md:text-2xl">Barreirinhas a Baixa Grande</h3>
                ...
                <p className="font-babe mt-2 md:mt-3 opacity-80 text-sm md:text-base">
                  Saída em lancha pelo Rio Preguiças com paradas em Vassouras, Mandacarú e Caburé. Desembarque em Atins e caminhada de 6 km até o oásis Baixa Grande, com paradas nas lagoas para banho e descanso.
                </p>
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-3.5rem)] md:w-[calc(50%-2.5rem)] bg-tamarina-creme p-5 md:p-6 rounded-sm shadow-md">
                <div className="flex items-center justify-between space-x-2 mb-1">
                  <h3 className="font-opti text-xl md:text-2xl">Baixa Grande a Queimada dos Britos</h3>
                  <span className="font-babe text-xs md:text-sm text-tamarina-oliva font-bold shrink-0">Sábado</span>
                </div>
                <p className="font-babe mt-2 md:mt-3 opacity-80 text-sm md:text-base">
                  Caminhada pelas lagoas cristalinas e dunas com paradas contemplativas. Almoço na Queimada dos Britos e pôr do sol em uma das dunas do oásis. Noite em redário tradicional.
                </p>
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-3.5rem)] md:w-[calc(50%-2.5rem)] bg-tamarina-creme p-5 md:p-6 rounded-sm shadow-md">
                <div className="flex items-center justify-between space-x-2 mb-1">
                  <h3 className="font-opti text-xl md:text-2xl">Queimada dos Britos a Lagoa do Junco</h3>
                  <span className="font-babe text-xs md:text-sm text-tamarina-oliva font-bold shrink-0">Domingo</span>
                </div>
                <p className="font-babe mt-2 md:mt-3 opacity-80 text-sm md:text-base">
                  Trecho mais desafiador com 14 km de caminhada até a Lagoa do Junco, em Santo Amaro. Tempo para banho e relaxamento antes do transfer de retorno.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 px-6 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
        <div>
          ...
          <ul className="space-y-3 md:space-y-4 font-babe opacity-90 text-sm md:text-base">
            <li className="flex gap-3"><div className="w-1.5 h-1.5 rounded-full bg-tamarina-oliva mt-2 shrink-0"></div>Transfer de chegada e retorno (São Luís → Barreirinhas / Santo Amaro → Barreirinhas ou São Luís)</li>
            <li className="flex gap-3"><div className="w-1.5 h-1.5 rounded-full bg-tamarina-oliva mt-2 shrink-0"></div>Passeio de lancha pelo Rio Preguiças com paradas em Vassouras, Mandacarú, Caburé e Atins</li>
            <li className="flex gap-3"><div className="w-1.5 h-1.5 rounded-full bg-tamarina-oliva mt-2 shrink-0"></div>Transfer 4x4 até o início da trilha</li>
            <li className="flex gap-3"><div className="w-1.5 h-1.5 rounded-full bg-tamarina-oliva mt-2 shrink-0"></div>Guias especializados durante todo o trekking</li>
            <li className="flex gap-3"><div className="w-1.5 h-1.5 rounded-full bg-tamarina-oliva mt-2 shrink-0"></div>Hospedagem nos oásis (Baixa Grande e Queimada dos Britos)</li>
            <li className="flex gap-3"><div className="w-1.5 h-1.5 rounded-full bg-tamarina-oliva mt-2 shrink-0"></div>Refeições no trekking (café da manhã, almoço e jantar)</li>
            <li className="flex gap-3"><div className="w-1.5 h-1.5 rounded-full bg-tamarina-oliva mt-2 shrink-0"></div>Chapéu personalizado + noite cortesia em Barreirinhas</li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-3 md:space-y-4 font-babe opacity-70 text-sm md:text-base">
            <li className="flex gap-3"><div className="w-1.5 h-1.5 rounded-full bg-tamarina-marrom/40 mt-2 shrink-0"></div>Passagens aéreas até São Luís</li>
            <li className="flex gap-3"><div className="w-1.5 h-1.5 rounded-full bg-tamarina-marrom/40 mt-2 shrink-0"></div>Bebidas durante as refeições</li>
            <li className="flex gap-3"><div className="w-1.5 h-1.5 rounded-full bg-tamarina-marrom/40 mt-2 shrink-0"></div>Snacks e lanches extras</li>
            <li className="flex gap-3"><div className="w-1.5 h-1.5 rounded-full bg-tamarina-marrom/40 mt-2 shrink-0"></div>Gastos pessoais e seguro viagem</li>
          </ul>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-tamarina-marrom text-tamarina-creme text-center px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="font-babe text-base md:text-lg mb-8 opacity-80 max-w-md mx-auto">
            As vagas para esta expedição já foram preenchidas. Quer ser avisada quando abrirmos novas datas?
          </p>

          <a
            href="https://wa.me/5534997391927?text=Olá! Vi que o grupo dos Lençóis está esgotado. Tenho interesse em ser avisada sobre o próximo grupo!"
            target="_blank"
          ...
          <p className="font-babe text-xs md:text-sm opacity-60 mt-6">
            Dúvidas? <a href="https://wa.me/5534997391927?text=Olá! Vi que o grupo dos Lençóis está esgotado. Tenho interesse em ser avisada sobre o próximo grupo!" target="_blank" rel="noopener noreferrer" className="underline hover:text-tamarina-areia cursor-pointer">Fale com a gente no WhatsApp</a>.
          </p>
        </div>
      </section>
    </main>
